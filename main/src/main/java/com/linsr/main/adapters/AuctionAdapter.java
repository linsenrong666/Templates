 ...
 */
public class AuctionAdapter extends BaseRecyclerAdapter<AuctionPojo> {
    ...
    public BaseViewHolder<AuctionPojo> onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Holder(mContext, mInflater.inflate(R.layout.main_item_auction, parent, false));
    }
