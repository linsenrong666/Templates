package com.linsr.common.utils.glide;
 ...
 * Description
 *
 * @author Linsr 2018/8/6 下午4:27
 */
public class GlideModelConfig implements GlideModule {

    private final static int DISK_SIZE = 1024 * 1024 * 100;
    private final static int MEMORY_SIZE = (int) (Runtime.getRuntime().maxMemory()) / 8;  // 取1/8最大内存作为最大缓存
